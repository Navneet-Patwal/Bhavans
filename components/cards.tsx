        ...
        className='flex flex-col items-start w-60 h-80 relative'>
            ...
            bottom-5 inset-x-5'>
                ...
                <View className='flex flex-row items-center justify-between w-full'>
                    <Text className='text-xl font-rubik-extrabold text-white'>250000</Text>
...
export const Card = ({onPress}:Props) => {
    return (
        <TouchableOpacity onPress={onPress} className='flex-1 w-full
        ...
        shadow-black-100/70 relative'>
            ...
            <View className='flex flex-col mt-2'>
                ...
                <View className='flex flex-row items-center justify-between mt-2'>
                    <Text className='text-base font-rubik-bold text-primary-300'>250000</Text>
